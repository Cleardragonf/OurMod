...
public class PortableChestTileEntity extends LockableLootTileEntity {
	...
	public PortableChestTileEntity(TileEntityType<?> typeIn) {
		super(typeIn);
	}

	public PortableChestTileEntity() {
		this(ModTileEntityTypes.PORTABLE_CHEST.get());
	}
	...
	protected Container createMenu(int id, PlayerInventory player) {
		return new PortableChestContainer(id, player, this);
	}
	...
	public static void swapContents(PortableChestTileEntity te, PortableChestTileEntity otherTe) {
