...
public class ForgeHeartStoneContainer extends Container {

	private ForgeHeartStoneContainer tileEntity;
	private IItemHandler playerInventory;
	private final IWorldPosCallable canInteractWithCallable;



	public ForgeHeartStoneContainer(final int windowId, final PlayerInventory playerInventory,
	...
	public ForgeHeartStone(final int windowId, final PlayerInventory playerInventory, final PacketBuffer data) {
