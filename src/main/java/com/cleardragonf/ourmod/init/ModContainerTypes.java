...
public class ModContainerTypes {
	...
	public static final RegistryObject<ContainerType<MasterWardStoneContainer>> MASTER_WARD_STONE = CONTAINER_TYPES.register("mcmchest", () -> IForgeContainerType.create(MasterWardStoneContainer::new ));
}
