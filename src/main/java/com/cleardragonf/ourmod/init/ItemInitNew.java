...
public class ItemInitNew {
	...
	public static final RegistryObject<Item> ASURA_BOOK = ITEMS.register("asurabook", () -> new AsuraBook(new Item.Properties().group(OurModItemGroup.instance)));
	public static final RegistryObject<Item> WARDS_BOOK = ITEMS.register("wardsbook", () -> new WardsBook(new Item.Properties().group(OurModItemGroup.instance)));
	...
	public static final RegistryObject<Item> WARD_STONES_ANTI_HUNGER = ITEMS.register("antihungerward", () -> new AntiHungerWard(new Item.Properties().group(OurModItemGroup.instance)));
	...
	public static final RegistryObject<Item> WARD_STONES_TEMPERATURE = ITEMS.register("temperatureward", () -> new TemperatureWard(new Item.Properties().group(OurModItemGroup.instance)));
	...
	public static final RegistryObject<Item> WARD_STONES_ANTI_PASSIVE = ITEMS.register("antipassiveward", () -> new AntiPassiveWard(new Item.Properties().group(OurModItemGroup.instance)));
